...
The diagnostician returns a single structured analysis. When the input carried a command sequence (stride-hook.sh shape), include the command-sequence context.
